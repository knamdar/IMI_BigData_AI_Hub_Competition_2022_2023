...
def plot_boxes(m1_mean, m1_sd, m1_5stats, m2_mean, m2_sd, m2_5stats):
    pval12 = ttest2(m1_mean,m2_mean,m1_sd,m2_sd,30,30)["p-value"]

    # #########################################################################
    plt.figure(figsize=(10, 8))
    ticks = ["Small Test", "Mega Test"]
    ...
    col = "midnightblue"
    plt.plot([x1, x1, x2, x2], [0.978, 0.979, 0.979, 0.977], lw=1.5, c=col)
    plt.text((x1+x2)*.5, 0.979, "p-value="+"{:.2E}".format(pval12), ha='center', va='bottom', color=col)
