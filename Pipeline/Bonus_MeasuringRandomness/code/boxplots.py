...
def plot_boxes(m1_mean, m1_sd, m1_5stats, m2_mean, m2_sd, m2_5stats):
    ...
    col = "midnightblue"
    plt.plot([x1, x1, x2, x2], [0.981, 0.982, 0.982, 0.981], lw=1.5, c=col)
    plt.text((x1+x2)*.5, 0.982, "p-value="+"{:.2E}".format(pval12), ha='center', va='bottom', color=col)
